...
export const PracticeData = [
    ...
    <!------------------------------------------------->*/
    {
        ...
        content: [
            'We advise our clients in venture capital investments in companies with high growth potential through a media for equity model, boosting its growth by strengthening its positioning and brand awareness in relevant markets. These media for equity transactions consist of tailor-made media campaigns through a rendering of advertising services in different media, such as free-to-air television, pay television, digital platforms and print media, in exchange of an equity participation in start-up companies of different sectors.'
        ],
        lang: 'EN'
    },
